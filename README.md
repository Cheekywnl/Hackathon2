...
- **AI** — Pitch transcription and scoring
...
| Criterion | How StartUp Addresses It |
|-----------|--------------------------|
| **Problem and impact** | Founders struggle to validate ideas and pitch well; StartUp gives them a low-friction way to test and improve before real events. |
| **Innovation and originality** | AI-powered pitch scoring tailored to hackathon categories; combines practice, feedback, and outreach in one flow. |
| **Technical execution** | Full-stack Next.js app with recording, transcription API, structured feedback, and persistent history. |
| **Functionality and completion** | End-to-end flow: account → record → feedback → investor directory → messaging. |
| **Presentation and clarity** | Clear UX, dark theme, and a focused user journey from first pitch to investor outreach. |
